...
// Set form data when doctor info is available
//
...
// //  Nested state handler for qualifications, experiences, timeSlots
// const handleNestedUpdate = (field, data) => {
//     setFormData(prev => ({ ...prev, [field]: data }));
// };


//     return (
//         <form onSubmit={handleSubmit} className="p-6 bg-white shadow-md rounded-md space-y-6">
...
//                 {formData.photo &&
//                     <img src={formData.photo} alt="Profile" className="mt-2 w-32 h-32 object-cover rounded-full" />
//                 }
//             </div>

//             {/* Basic Info */}
//             <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
//                 <input type="text" name="name" placeholder="Full Name" value={formData.name} onChange={handleChange} className="form_input" />
//                 <input type="email" name="email" placeholder="Email" value={formData.email} onChange={handleChange} className="form_input" />
//                 <input type="text" name="phone" placeholder="Phone Number" value={formData.phone} onChange={handleChange} className="form_input" />
//                 <input type="text" name="specialization" placeholder="Specialization" value={formData.specialization} onChange={handleChange} className="form_input" />
//                 <input type="number" name="ticketPrice" placeholder="Ticket Price" value={formData.ticketPrice} onChange={handleChange} className="form_input" />
//             </div>

//             <textarea name="about" placeholder="About" value={formData.about} onChange={handleChange} className="w-full border px-3 py-2 rounded" rows="3" />


//             <QualificationInput
//                 qualifications={formData.qualifications}
//                 onAdd={(data) => handleNestedUpdate('qualifications', [...formData.qualifications, data])}
//                 onUpdate={(data, index) =>
//                     handleNestedUpdate('qualifications', formData.qualifications.map((item, i) => i === index ? data : item))
//                 }
//                 onDelete={(index) =>
//                     handleNestedUpdate('qualifications', formData.qualifications.filter((_, i) => i !== index))
//                 }
//             />
//             <ExperienceInput
//                 experiences={formData.experiences}
//                 onAdd={(data) => handleNestedUpdate('experiences', [...formData.experiences, data])}
//                 onUpdate={(data, index) =>
//                     handleNestedUpdate('experiences', formData.experiences.map((item, i) => i === index ? data : item))
//                 }
//                 onDelete={(index) =>
//                     handleNestedUpdate('experiences', formData.experiences.filter((_, i) => i !== index))
//                 }
//             />

//             <TimeSlotInput
//                 timeSlots={formData.timeSlots}
//                 onAdd={(data) => handleNestedUpdate('timeSlots', [...formData.timeSlots, data])}
//                 onUpdate={(data, index) =>
//                     handleNestedUpdate('timeSlots', formData.timeSlots.map((item, i) => i === index ? data : item))
//                 }
//                 onDelete={(index) =>
//                     handleNestedUpdate('timeSlots', formData.timeSlots.filter((_, i) => i !== index))
//                 }
//             />
