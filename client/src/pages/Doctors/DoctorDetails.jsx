...
const DoctorDetails = () => {
    ...
    const { id } = useParams()
    const { loading, data: doctor, error } = useFetchData(`${BASE_URL}/doctors/${id}`)
                    ...
                    <div className='md:col-span-2'>
                        <div className='flex items-center gap-5'>
                            ...
                            lg:text-[16px] lg:leading-7 font-semibold text-headingColor">
                                    ...
                                    <span className="text-[14px] leading-5 lg:text-[16px] lg:leading-7 fonr-[400] text-textCOlor">({totalRating})</span>
                                </div>
                                <p className="text_para text-[14px] leading-5 lg:max-w-[390px] ">
                                    {bio}
                                </p>
                            </div>
                        ...
                        <div className="mt-[50px] border-b border-sol border-[#0066ff34]">
                            <button
